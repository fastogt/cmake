...
MACRO(INSTALL_RUNTIME_LIBRARIES)
    ...
    IF(MINGW)
        ...
        SET(CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS ${Mingw_Path}/libgcc_s_dw2-1.dll ${Mingw_Path}/libgcc_s_seh-1.dll ${Mingw_Path}/libstdc++-6.dll ${Mingw_Path}/libwinpthread-1.dll)
    ENDIF(MINGW)
