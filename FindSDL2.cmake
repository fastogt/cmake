...
IF(SDL2_IMAGE_INCLUDE_DIR)
  SET(SDL2_INCLUDE_DIRS ${SDL2_INCLUDE_DIRS} ${SDL2_IMAGE_INCLUDE_DIR})
ENDIF(SDL2_IMAGE_INCLUDE_DIR)
FIND_LIBRARY(SDL2_IMAGE_LIBRARY NAMES SDL2_image)
IF(SDL2_IMAGE_LIBRARY)
  SET(SDL2_LIBRARIES ${SDL2_LIBRARIES} ${SDL2_IMAGE_LIBRARY})
ENDIF(SDL2_IMAGE_LIBRARY)

# ttf
FIND_PATH(SDL2_TTF_INCLUDE_DIR SDL2/SDL_ttf.h)
IF(SDL2_TTF_INCLUDE_DIR)
  SET(SDL2_INCLUDE_DIRS ${SDL2_INCLUDE_DIRS} ${SDL2_TTF_INCLUDE_DIR})
...
IF(WIN32)
  ...
  SET(SDL2_LIBRARIES ${SDL2_LIBRARIES} ${MINGW32_LIBRARY} ${SDL2_MAIN_LIBRARY})
ENDIF(WIN32)
