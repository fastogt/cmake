...
MACRO(INTEGRATE_QT)
  ...
  IF(DEVELOPER_BUILD_TESTS)
    SET(QT_COMPONENTS_TO_USE ${QT_COMPONENTS_TO_USE} Qt6Test)
  ENDIF(DEVELOPER_BUILD_TESTS)

  FOREACH(qtComponent ${QT_COMPONENTS_TO_USE})
    IF(NOT ${qtComponent} STREQUAL "Qt6ScriptTools")
    ...
    # STRING(REGEX REPLACE "Qt6" "" COMPONENT_SHORT_NAME ${qtComponent})
    # SET(QT_MODULES_TO_USE ${QT_MODULES_TO_USE} ${COMPONENT_SHORT_NAME})

    IF(${${qtComponent}_FOUND})
      IF(NOT(${qtComponent} STREQUAL "Qt6LinguistTools"))
        STRING(REGEX REPLACE "Qt6" "" componentShortName ${qtComponent})
        SET(QT_LIBRARIES ${QT_LIBRARIES} "Qt6::${componentShortName}")
      ENDIF()
    ENDIF()
...
LIST(FIND QT_COMPONENTS_TO_USE "Qt6Xml" QT_XML_INDEX)
IF(NOT ${QT_XML_INDEX} EQUAL -1)
  GET_TARGET_PROPERTY(libLocation ${Qt6Xml_LIBRARIES} LOCATION)
...
IF(UNIX AND NOT APPLE)
  #Qt6XcbQpa
  FIND_LIBRARY(Qt6XcbQpa_LIBRARIES NAMES Qt6XcbQpa PATHS "${QT_LIBS_DIR}" NO_DEFAULT_PATH)
  GET_FILENAME_COMPONENT(LibWithoutSymLink ${Qt6XcbQpa_LIBRARIES} REALPATH)
