...
FUNCTION(DEFINE_DEFAULT_DEFINITIONS ENABLE_RTTI USE_FPIC ENABLE_WERROR)
  ...
  IF(USE_FPIC)
    SET(PATHED_C_FLAGS "-fPIC")
    SET(PATHED_CXX_FLAGS "-fPIC")
  ENDIF(USE_FPIC)
  IF(MSVC)
    SET(PATHED_CXX_FLAGS "${PATHED_CXX_FLAGS} -Zi")
  ENDIF(MSVC)
  SET(PATHED_CXX_FLAGS "${PATHED_CXX_FLAGS} -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables")
  IF(NOT ENABLE_RTTI)
    SET(PATHED_CXX_FLAGS "${PATHED_CXX_FLAGS} -fno-rtti")
  ENDIF(NOT ENABLE_RTTI)
  IF(ENABLE_WERROR)
    SET(PATHED_CXX_FLAGS "${PATHED_CXX_FLAGS} -Werror")
  ENDIF(ENABLE_WERROR)
  # -fvisibility-inlines-hidden -fno-threadsafe-statics -fno-rtti
  SET(PATHED_CXX_FLAGS "${PATHED_CXX_FLAGS} -Wall -Wextra -pedantic -Wswitch-enum") # -Wconversion -Wunreachable-code-return
  IF(CMAKE_COMPILER_IS_GNUCXX AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 5.1)
    SET(PATHED_CXX_FLAGS "${PATHED_CXX_FLAGS} -Wsuggest-override")
  ENDIF(CMAKE_COMPILER_IS_GNUCXX AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 5.1)

  SET(CMAKE_C_FLAGS ${PATHED_C_FLAGS} PARENT_SCOPE)
  SET(CMAKE_CXX_FLAGS ${PATHED_CXX_FLAGS} PARENT_SCOPE)
...
FUNCTION(SIGN_TARGET EXECUTABLE_NAME)
  INSTALL(CODE "execute_process(COMMAND fastogtsign.py sign \"$ENV{SIGNING_IDENTITY}\" ${CMAKE_INSTALL_PREFIX}/${EXECUTABLE_NAME})" COMPONENT RUNTIME)
