...
MACRO(FIXUP_LIBS_IN_BUNDLE BUNDLE_PATH LIB_DIST)
    SET(APPS ${BUNDLE_PATH})  # should be visible for fixup_bundle
    INSTALL(CODE "
      FILE(GLOB_RECURSE QTPLUGINS_FIXUP
      \"\${CMAKE_INSTALL_PREFIX}/*${CMAKE_SHARED_LIBRARY_SUFFIX}\")
      include(BundleUtilities)
      fixup_bundle(\"${APPS}\" \"\${QTPLUGINS_FIXUP}\" \"${LIB_DIST}\")
      " COMPONENT RUNTIME)
ENDMACRO(FIXUP_LIBS_IN_BUNDLE BUNDLE_PATH LIB_DIST)

FUNCTION(INSTALL_LIB_TO_BUNDLE BUNDLE_PATH LIB_PATH)
  SET(APPS ${BUNDLE_PATH})  # should be visible for fixup_bundle
  GET_FILENAME_COMPONENT(LIB_DIR ${LIB_PATH} DIRECTORY)
  INSTALL(CODE "
        include(BundleUtilities)
        fixup_bundle(\"${APPS}\" \"\${LIB_PATH}\" \"${LIB_DIR}\")
        " COMPONENT RUNTIME)
